module.exports = {
  'Test for EMS-APPLICATION' : function (client) {
    client
      .url('http://172.27.59.196:5050/EmployeeApplicationSprint4-1.0-SNAPSHOTn/jsp/add.jsp')
  ...
  'List of Employees' : function(client,browser){
	  client
	  .url('http://172.27.59.196:5050/EmployeeApplicationSprint4-1.0-SNAPSHOTn/list')
	  .waitForElementVisible('body', 1000)
	...
	.getText('body > div.smart-green > table > tbody > tr:nth-child(82) > td:nth-child(3)', function(result) {
    this.assert.equal(result.value, 'chennai')
